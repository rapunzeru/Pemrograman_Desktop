Public Class Form1
    ...
    Private Function Faktorial(ByVal n As Integer) As Integer
        If n = 0 Or n = 1 Then
            Return 1
        Else
    ...
    Private Sub btnFaktorial_Click(sender As Object, e As EventArgs) Handles btnFaktorial.Click
        ...
        txtInput.Text = Faktorial(angka).ToString()
    End Sub

    Private Sub btnAkarPangkat3_Click(sender As Object, e As EventArgs) Handles btnAkarPangkat3.Click
        Dim angka As Double = CDbl(txtInput.Text)
