...
Public Class frmLangganan
    ...
    Private Sub btnTambah_Click(sender As System.Object, e As System.EventArgs) Handles btnTambah.Click
        ...
        ElseIf btnTambah.Text = "Simpan" Then
            ...
            Dim waktu As String = hasil.ToString("yyyy-MM-dd")
            Dim biaya As Long

            If Not Long.TryParse(txtBiaya.Text.Trim(), biaya) Then
                MessageBox.Show("Masukkan biaya yang valid!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If

            Dim sql As String = "INSERT INTO tbllangganan(no_plat, nama, jenis, biaya, expired) VALUES ('" &
                            txtNoPlat.Text & "','" & txtNama.Text & "','" & cmbJenis.Text & "'," &
                            biaya & ",'" & waktu & "')"
    ...
    Private Sub btnHapus_Click(sender As System.Object, e As System.EventArgs) Handles btnHapus.Click
        ...
        If DataGridView1.CurrentRow.Cells(0).Value.ToString <> "" Then
            If MessageBox.Show("Delete this record?", "Warning",
           MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) =
           System.Windows.Forms.DialogResult.Yes Then
                Dim sql As String = "delete from tbllangganan where id=" &
