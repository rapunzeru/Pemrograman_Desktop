...
Public Class Form1
    ...
    Private Sub rbReplaceWithF_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceWithF.CheckedChanged
    ...
    Private Sub rbReplaceThisF_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceThisF.CheckedChanged
    ...
    Private Sub btnPreview_Click(sender As Object, e As EventArgs) Handles btnPreview.Click
        ...
        ElseIf mode = "RE" Then 'replace with E
            For i As Integer = 0 To arrFile2.Count - 1
                arrExt2(i) = arrExt2(i).Replace(arrExt2(i).Substring(1),
               txtReplaceWithE.Text)
        ...
        ElseIf mode = "IAE" Then 'insert after E
            For i As Integer = 0 To arrExt2.Count - 1
                arrExt2(i) = arrExt2(i).Insert(arrExt2(i).Length,
               txtInsertAfterE.Text)
                lvPreview.Items(i).SubItems(1).Text = Trim(arrExt2(i))
            Next
    ...
    Private Sub rbInsertBeforeF_CheckedChanged(sender As Object, e As EventArgs) Handles rbInsertBeforeF.CheckedChanged
    ...
    Private Sub rbInsertAfterF_CheckedChanged(sender As Object, e As EventArgs) Handles rbInsertAfterF.CheckedChanged
    ...
    Private Sub rbLeftCropNCharF_CheckedChanged(sender As Object, e As EventArgs) Handles rbLeftCropNCharF.CheckedChanged
    ...
    Private Sub txtRightCropNCharF_TextChanged(sender As Object, e As EventArgs) Handles txtRightCropNCharF.TextChanged
    ...
    Private Sub rbReplaceWithE_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceWithE.CheckedChanged
    ...
    Private Sub rbReplaceThisE_CheckedChanged(sender As Object, e As EventArgs) Handles rbReplaceThisE.CheckedChanged
    ...
    Private Sub rbInsertBeforeE_CheckedChanged(sender As Object, e As EventArgs) Handles rbInsertBeforeE.CheckedChanged
    ...
    Private Sub rbInsertAfterE_CheckedChanged(sender As Object, e As EventArgs) Handles rbInsertAfterE.CheckedChanged
    ...
    Private Sub rbLeftCropNCharE_CheckedChanged(sender As Object, e As EventArgs) Handles rbLeftCropNCharE.CheckedChanged
    ...
    Private Sub rbRightCropNCharE_CheckedChanged(sender As Object, e As EventArgs) Handles rbRightCropNCharE.CheckedChanged
